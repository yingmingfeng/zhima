window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const tagId$4 = "@dsh-overlay/better-sidebar/sidebar.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$4) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@dsh-overlay/better-sidebar";
		...
		*/
		...
		const tagId$3 = "@dsh-overlay/better-sidebar/SideCardSection.module.css";
...
Mode: this is a continuable side conversation. Your answers stay in this side thread and are viewed in the side panel; they are never delivered into the parent session.`;
		...
		*/
		...
		const tagId$2 = "@dsh-overlay/better-sidebar/SubagentView.module.css";
		...
		*/
		...
		const tagId$1 = "@dsh-overlay/better-sidebar/SideChatView.module.css";
		...
		*/
		...
		const tagId = "@dsh-overlay/better-sidebar/layout.css";
