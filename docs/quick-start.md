...
1. 将 **UI TARS** 应用拖入 **Applications** 文件夹
   <img src="../apps/zhima/images/mac_install.png" width="500px" />

2. 在 MacOS 中授予 **UI TARS** 必要权限：
   - 系统设置 -> 隐私与安全性 -> **辅助功能**
   - 系统设置 -> 隐私与安全性 -> **屏幕录制**
   <img src="../apps/zhima/images/mac_permission.png" width="500px" />

3. 打开 **UI TARS** 应用，您将看到如下界面：
   <img src="../apps/zhima/images/mac_app.png" width="500px" />

### Windows

**直接运行** 应用，您将看到如下界面：

<img src="../apps/zhima/images/windows_install.png" width="400px" style="margin-left: 4em;" />
...
1. 在页面右上角点击 `Deploy from Hugging Face` 按钮
   <img src="../apps/zhima/images/quick_start/huggingface_deploy.png" width="500px" />

2. 选择模型 UI-TARS-1.5-7B
   <img src="../apps/zhima/images/quick_start/huggingface_uitars_1.5.png" width="500px" />
...
>
> <img src="../apps/zhima/images/quick_start/base_url.png" width="500px" />

<img src="../apps/zhima/images/quick_start/huggingface_setting.png" width="500px" />

5. 点击按钮开始新对话

   <img src="../apps/zhima/images/quick_start/start_button.png" width="500px" />

6. 输入指令，开始一轮 GUI 操作任务！

   <img src="../apps/zhima/images/quick_start/start_task.png" width="500px" />
...
2. 点击页面右上角的`立即体验`按钮
   <img src="../apps/zhima/images/quick_start/volcengine_try.png" width="500px" />

3. 点击 `API 接入` 链接
   <img src="../apps/zhima/images/quick_start/volcengine_api.png" width="500px" />

4. 在抽屉面板的 STEP 1 中获取您的 **API Key**
   <img src="../apps/zhima/images/quick_start/volcengine_api_key.png" width="500px" />

5. 在 STEP 2 中完成用户信息认证，切换到 OpenAI SDK 选项卡以获取 **Base URL** 和 **Model Name**：
   <img src="../apps/zhima/images/quick_start/volcengine_api_info.png" width="500px" />
...
<img src="../apps/zhima/images/quick_start/volcengine_settings.png" width="500px" />
