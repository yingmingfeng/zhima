 ...
 */
// [停用 browser-use] import { DefaultBrowserOperator } from '@ui-tars/operator-browser';
 ...
 */
// [停用 browser-use] 整个函数依赖 @ui-tars/operator-browser，已随 browser-use 一并停用，仅保留 computer-use。
