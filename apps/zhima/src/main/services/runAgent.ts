...
import { GUIAgent, type GUIAgentConfig } from '@zhima/sdk';
...
// [停用 browser-use] import { DefaultBrowserOperator, RemoteBrowserOperator } from '@zhima/operator-browser';
...
import { UITarsModelConfig } from '@zhima/sdk/core';
...
export const runAgent = async (
  ...
  switch (settings.operator) {
    case Operator.LocalComputer:
      ...
      break;
    // [停用 browser-use] case Operator.LocalBrowser: ...（依赖 @zhima/operator-browser，已停用）
    /*
    ...
    */
    case Operator.RemoteComputer:
      ...
      operatorType = 'computer';
      break;
    // [停用 browser-use] case Operator.RemoteBrowser: ...（依赖 @zhima/operator-browser，已停用）
    /*
